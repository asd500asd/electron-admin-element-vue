...
export function importAllLocales(): LocaleMessages<VueMessageType> {
  ...
  try {
    ...
    const viewsRequireContext: __WebpackModuleApi.RequireContext =
      require.context(
        "../views",
        true,
        /[/\\]locales[/\\]([a-z]{2})-?([A-Z]{2})?\.ts$/
      );
    ...
    const layoutsRequireContext: __WebpackModuleApi.RequireContext =
      require.context(
        "../layouts",
        true,
        /[/\\]locales[/\\]([a-z]{2})-?([A-Z]{2})?\.ts$/
    ...
    const componentsRequireContext: __WebpackModuleApi.RequireContext =
      require.context(
        "../components",
        true,
        /[/\\]locales[/\\]([a-z]{2})-?([A-Z]{2})?\.ts$/
    ...
    const localesRequireContext: __WebpackModuleApi.RequireContext =
      require.context("../locales", false, /([a-z]{2})-?([A-Z]{2})?\.ts$/);
